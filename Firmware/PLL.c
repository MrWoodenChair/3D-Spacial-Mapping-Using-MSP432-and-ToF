...
#define MINT        52  // 480,000,000 = (25,000,000/(0 + 1)/(4 + 1))*(96 + (0/1,024))	//Changed to 52 instead of 96
#define MFRAC        0  // zero to reduce jitter
  //    SysClk = fVCO / (PSYSDIV + 1)
#define SYSCLK (FXTAL/(Q+1)/(N+1))*(MINT+MFRAC/1024)/(PSYSDIV+1)	//Changed Physdiv to 9 and MINT to 52 to ge tthe 26MHz
