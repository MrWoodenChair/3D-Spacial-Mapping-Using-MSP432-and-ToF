...
//Do not need to change systic wait since already operating at clk speed
...
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
		//1200000 for 10ms delay
    SysTick_Wait(260000);  // Wait 10ms (Calculation: 26,000,000 cycles/sec * 0.01 sec = 260,000)
  }
}
